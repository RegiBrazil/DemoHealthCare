//HCIPDB01 JOB ,'COMPILE COBOL',NOTIFY=&SYSUID,CLASS=A,MSGCLASS=H,
//       REGION=0M
//*
//* Compile, link program   HCIPDB01
//*
//*-------------------------------------------------------------------*
//DB2PROC  PROC
//*-------------------------------------------------------------------*
...
//SYSUT1   DD DISP=SHR,DSN=DFH540.CICS.SDFHCOB(DFHEILIC)
...
//SYSLIB   DD DISP=SHR,DSN=DFH540.CICS.SDFHLOAD
//         DD DSN=DSNB10.SDSNLOAD,DISP=SHR
