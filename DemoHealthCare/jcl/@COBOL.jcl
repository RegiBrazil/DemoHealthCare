//HCMACOMP JOB ,'COB GENERATE',CLASS=A,MSGCLASS=H,
//       REGION=0M
//*
//* Changed by REGI on Feb 16 2021 to compile for Debug
//*
//*
// SET HLQ=IBMUSER.GIT
// SET CICSHLQ=DFH550.CICS
//* SET DSNAHLQ=DSNC10.DBCG
// SET DB2HLQ=DSNC10
// SET COBHLQ=IGY630
//*-------------------------------------------------------------------*
//DB2PROC  PROC
...
//         DD DSN=&HLQ..ZMOBILE.COPY,DISP=SHR
