...
/**
 * This is the main build script for the HCAZ Application + invoke zUnit.
 *
...
if (buildList.size() == 0)
	...
	def buildOrder = ["BMSProcessing", "Compile", "LinkEdit", "CobolCompile", "JCL"]
	...
	buildOrder.each { script ->
		...
		def scriptName = "$properties.sourceDir/DemoHealthCare/build/${script}.groovy"
...
// ADDED to INVOKE ZUNIT
def zunitrun = "$properties.sourceDir/DemoHealthCare/build/RunZUnitJCLCCDB02.groovy"
