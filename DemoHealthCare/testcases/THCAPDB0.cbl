      ...
      *| Date Generated: 06/04/2020 16:35                              |
      *| ID: be8044c2-9f48-4357-9fbb-987cb5d17e35                      |
      *+---------------------------------------------------------------+
      *+---------------------------------------------------------------+
      *| TEST_TEST3                                                    |
      ...
      *+---------------------------------------------------------------+
       ...
       01 PROGRAM-NAME   PIC X(8)  VALUE 'HCAPDB01'.
       01 AZ-ASSERT.
       ...
       1 AZ-TEST-EXPECTED-DATA-VALUE.
          ...
          3 ZUT00000008.
            5 PIC X(20) DISPLAY VALUE SPACES.
          3 ZUT00000009.
            5 PIC X(50) DISPLAY VALUE SPACES.
          3 ZUT0000000A.
            5 PIC X(5) DISPLAY VALUE 'regi2'.
            5 PIC X(5) DISPLAY VALUE SPACES.
          3 ZUT0000000B.
      ...
      * EVALUATE OUTPUT VALUE
           ...
           ZUT0000000F(2)
             ...
             IF (CA-PATIENT-ID OF DFHCOMMAREA IS NUMERIC)
                 AND (CA-PATIENT-ID OF DFHCOMMAREA = 0000000008) THEN
               CONTINUE
             ELSE
               MOVE CA-PATIENT-ID OF DFHCOMMAREA TO ZUT00000011(1)
               MOVE 0000000008 TO ZUT00000011(2)
      ...
      *+---------------------------------------------------------------+
       ...
       01 AZ-TESTCASE-ID        PIC X(36)
           VALUE 'be8044c2-9f48-4357-9fbb-987cb5d17e35'.
       LINKAGE SECTION.
       01 AZ-TEST               PIC X(80).
      ...
      *+---------------------------------------------------------------+
       ...
       PROCEDURE DIVISION.
      * CHECK OUTPUT VALUE
      * CICS_INPT_0E08_HCAPDB01.
           ENTRY 'CICS_INPT_0E08_HCAPDB01' USING AZ-TEST
           AZ-INFO-BLOCK AZ-DFHEIBLK AZ-DFHCOMMAREA ARG0 ARG1 ARG2
           ARG3 ARG4 ARG5 ARG6 ARG7 ARG8 ARG9 ARG10.
           DISPLAY 'CICS_0E08_HCAPDB01 CHECK VALUES...'
           MOVE 4 TO RETURN-CODE.
      ...
      * EXEC CICS RETURN X'0000'
           ...
           PERFORM TEARDOWN.
      * SET INPUT VALUE
      * CICS_OUTP_0E08_HCAPDB01.
           ENTRY 'CICS_OUTP_0E08_HCAPDB01' USING AZ-TEST
           AZ-INFO-BLOCK AZ-DFHEIBLK AZ-DFHCOMMAREA ARG0 ARG1 ARG2
           ARG3 ARG4 ARG5 ARG6 ARG7 ARG8 ARG9 ARG10.
           DISPLAY 'CICS_0E08_HCAPDB01 INPUT VALUES...'
           MOVE 0 TO RETURN-CODE.
           MOVE 0 TO AZ-TEST-LEN.
           INSPECT AZ-TEST TALLYING AZ-TEST-LEN FOR
           CHARACTERS BEFORE INITIAL SPACE.
      ...
      * END
       TEARDOWN.
           DISPLAY 'CICS_0E08_HCAPDB01 Successful.'
           GOBACK.
       END PROGRAM 'CICS_0E08_HCAPDB01'.
