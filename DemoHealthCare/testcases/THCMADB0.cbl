      ...
      *| DATE GENERATED: 04/08/2021 15:35                              |
      ...
      *+---------------------------------------------------------------+
       ...
       1 AZ-COMPARE-WORK-ITEMS.
          ...
          3 ZUT00000026 PIC X(32317) OCCURS 2.
       01 AZ-CONVERT.
      ...
      * EVALUATE OUTPUT VALUE
           ...
           ZUT00000024(2)
             ...
             PERFORM THROW-ASSERTION
           END-IF
           IF CA-ADDITIONAL-DATA OF CA-MEDICATION-REQUEST OF
           DFHCOMMAREA = ZUT0000000A THEN
             CONTINUE
           ELSE
             MOVE CA-ADDITIONAL-DATA OF CA-MEDICATION-REQUEST OF
      ...
      * EVALUATE OUTPUT VALUE
           ...
           DFHCOMMAREA IS NUMERIC)
               AND (CA-PRESCRIPTION-ID OF CA-MEDICATION-REQUEST OF
           DFHCOMMAREA = 1001153) THEN
             CONTINUE
           ELSE
             MOVE CA-PRESCRIPTION-ID OF CA-MEDICATION-REQUEST OF
           DFHCOMMAREA TO ZUT0000004B(1)
             MOVE 1001153 TO ZUT0000004B(2)
