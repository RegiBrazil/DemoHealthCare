      ...
      *| DATE GENERATED: 10/30/2020 12:55                              |
      *| ID: 91eb74f1-9d83-4f4a-9efe-3bdaa06b55cf                      |
      *+---------------------------------------------------------------+
      *+---------------------------------------------------------------+
      *| TEST_TEST2                                                    |
      ...
      *+---------------------------------------------------------------+
       ...
       01 PROGRAM-NAME   PIC X(8)  VALUE 'HCP1BI01'.
       01 BZ-ASSERT.
       ...
       1 AZ-COMPARE-WORK-ITEMS.
          3 ZUT00000005 PIC X(6) OCCURS 2.
          3 ZUT00000007 PIC 9(2) OCCURS 2.
          3 ZUT00000009 PIC 9(10) OCCURS 2.
          3 ZUT0000000B PIC X(10) OCCURS 2.
          3 ZUT0000000D PIC X(10) OCCURS 2.
          3 ZUT0000000F PIC X(20) OCCURS 2.
       LINKAGE SECTION.
       01 AZ-TEST                   PIC X(80).
       01 AZ-ARG-LIST.
      ...
      * EVALUATE OUTPUT VALUE
           ...
           IF CA-REQUEST-ID OF DFHCOMMAREA = ZUT00000000 THEN
             CONTINUE
           ELSE
             MOVE CA-REQUEST-ID OF DFHCOMMAREA TO ZUT00000005(1)
           ...
           IF (CA-RETURN-CODE OF DFHCOMMAREA IS NUMERIC)
             ...
             CONTINUE
           ELSE
             MOVE CA-RETURN-CODE OF DFHCOMMAREA TO ZUT00000007(1)
           ...
           IF (CA-PATIENT-ID OF DFHCOMMAREA IS NUMERIC)
             ...
             CONTINUE
           ELSE
             MOVE CA-PATIENT-ID OF DFHCOMMAREA TO ZUT00000009(1)
             MOVE 1 TO ZUT00000009(2)
           ...
           TO ZUT0000000B(1)
             MOVE ZUT00000001 TO ZUT0000000B(2)
           ...
           TO ZUT0000000D(1)
             MOVE ZUT00000002 TO ZUT0000000D(2)
           ...
           ZUT0000000F(1)
             MOVE ZUT00000003 TO ZUT0000000F(2)
      ...
      *+---------------------------------------------------------------+
       ...
       1 AZ-COMPARE-WORK-ITEMS.
          ...
          3 ZUT00000017 PIC 9(2) OCCURS 2.
          3 ZUT00000019 PIC 9(10) OCCURS 2.
          3 ZUT0000001B PIC X(10) OCCURS 2.
          3 ZUT0000001D PIC X(10) OCCURS 2.
          3 ZUT0000001F PIC X(20) OCCURS 2.
       LINKAGE SECTION.
       01 AZ-TEST                   PIC X(80).
       01 AZ-ARG-LIST.
         03 ARG-LENGTH PIC 9(4) COMP-4.
      ...
      * EVALUATE OUTPUT VALUE
           ...
           IF CA-REQUEST-ID OF DFHCOMMAREA = ZUT00000010 THEN
             CONTINUE
           ELSE
             MOVE CA-REQUEST-ID OF DFHCOMMAREA TO ZUT00000015(1)
           ...
           IF (CA-RETURN-CODE OF DFHCOMMAREA IS NUMERIC)
             ...
             CONTINUE
           ELSE
             MOVE CA-RETURN-CODE OF DFHCOMMAREA TO ZUT00000017(1)
             MOVE 0 TO ZUT00000017(2)
           ...
           IF (CA-PATIENT-ID OF DFHCOMMAREA IS NUMERIC)
             ...
             CONTINUE
           ELSE
             MOVE CA-PATIENT-ID OF DFHCOMMAREA TO ZUT00000019(1)
             MOVE 1 TO ZUT00000019(2)
           ...
           ELSE
             MOVE CA-INS-CARD-NUM OF CA-PATIENT-REQUEST OF DFHCOMMAREA
           TO ZUT0000001B(1)
             MOVE ZUT00000011 TO ZUT0000001B(2)
           ...
           ELSE
             MOVE CA-FIRST-NAME OF CA-PATIENT-REQUEST OF DFHCOMMAREA
           TO ZUT0000001D(1)
             MOVE ZUT00000012 TO ZUT0000001D(2)
           ...
           ELSE
             MOVE CA-LAST-NAME OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT0000001F(1)
             MOVE ZUT00000013 TO ZUT0000001F(2)
      ...
      * EVALUATE OUTPUT VALUE
           MOVE 0 TO RETURN-CODE
           IF CA-REQUEST-ID OF DFHCOMMAREA = ZUT00000020 THEN
             CONTINUE
           ELSE
             MOVE CA-REQUEST-ID OF DFHCOMMAREA TO ZUT00000025(1)
             MOVE ZUT00000020 TO ZUT00000025(2)
           ...
           IF (CA-RETURN-CODE OF DFHCOMMAREA IS NUMERIC)
             ...
             CONTINUE
           ELSE
             MOVE CA-RETURN-CODE OF DFHCOMMAREA TO ZUT00000027(1)
             MOVE 0 TO ZUT00000027(2)
           ...
           IF (CA-PATIENT-ID OF DFHCOMMAREA IS NUMERIC)
             ...
             CONTINUE
           ELSE
             MOVE CA-PATIENT-ID OF DFHCOMMAREA TO ZUT00000029(1)
             MOVE 2 TO ZUT00000029(2)
           ...
           ELSE
             MOVE CA-INS-CARD-NUM OF CA-PATIENT-REQUEST OF DFHCOMMAREA
           TO ZUT0000002B(1)
             MOVE ZUT00000021 TO ZUT0000002B(2)
           ...
           ELSE
             MOVE CA-FIRST-NAME OF CA-PATIENT-REQUEST OF DFHCOMMAREA
           TO ZUT0000002D(1)
             MOVE ZUT00000022 TO ZUT0000002D(2)
           ...
           ELSE
             MOVE CA-LAST-NAME OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT0000002F(1)
             MOVE ZUT00000023 TO ZUT0000002F(2)
      ...
      *+---------------------------------------------------------------+
       ...
       01 AZ-TESTCASE-ID        PIC X(36)
           VALUE '91eb74f1-9d83-4f4a-9efe-3bdaa06b55cf'.
       LINKAGE SECTION.
       01 AZ-TEST               PIC X(80).
      ...
      *+---------------------------------------------------------------+
       ...
       PROCEDURE DIVISION.
      * CHECK OUTPUT VALUE
      * CICS_INPT_0E08_HCP1BI01.
           ENTRY 'CICS_INPT_0E08_HCP1BI01' USING AZ-TEST
           AZ-INFO-BLOCK AZ-DFHEIBLK AZ-DFHCOMMAREA ARG0 ARG1 ARG2
           ARG3 ARG4 ARG5 ARG6 ARG7 ARG8 ARG9 ARG10.
           DISPLAY 'CICS_0E08_HCP1BI01 CHECK VALUES...'
           MOVE 4 TO RETURN-CODE.
      ...
      * EXEC CICS RETURN X'0000'
           ...
           PERFORM TEARDOWN.
      * SET INPUT VALUE
      * CICS_OUTP_0E08_HCP1BI01.
           ENTRY 'CICS_OUTP_0E08_HCP1BI01' USING AZ-TEST
           AZ-INFO-BLOCK AZ-DFHEIBLK AZ-DFHCOMMAREA ARG0 ARG1 ARG2
           ARG3 ARG4 ARG5 ARG6 ARG7 ARG8 ARG9 ARG10.
           DISPLAY 'CICS_0E08_HCP1BI01 INPUT VALUES...'
           MOVE 0 TO RETURN-CODE.
           MOVE 0 TO AZ-TEST-LEN.
           INSPECT AZ-TEST TALLYING AZ-TEST-LEN FOR
           CHARACTERS BEFORE INITIAL SPACE.
      ...
      * EXEC CICS RETURN X'0000'
       ...
       GETLINENUM.
           ...
           EXIT.
       TEARDOWN.
           DISPLAY 'CICS_0E08_HCP1BI01 SUCCESSFUL.'
           GOBACK.
       END PROGRAM 'CICS_0E08_HCP1BI01'.
