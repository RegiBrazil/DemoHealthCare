      ...
      *+---------------------------------------------------------------+
       ...
       1 AZ-COMPARE-ITEM-NAMES.
         ...
         3 ZUT00000067.
            ...
            5 PIC X(13) DISPLAY VALUE 'F DFHCOMMAREA'.
       1 AZ-COMPARE-WORK-ITEMS.
          3 ZUT00000058 PIC X(6) OCCURS 2.
          3 ZUT0000005A PIC 9(2) OCCURS 2.
          3 ZUT0000005C PIC 9(10) OCCURS 2.
          ...
          3 ZUT00000068 PIC X(64864) OCCURS 2.
       01 AZ-CONVERT.
         03 AZ-CONVERT-HEXIN  PIC X(1).
         03 AZ-CONVERT-HEXVAL PIC X(2).
         03 AZ-HEXSTR PIC X(16) VALUE "0123456789ABCDEF".
      ...
      * EVALUATE OUTPUT VALUE
           ...
           IF CA-REQUEST-ID OF DFHCOMMAREA = ZUT00000050 THEN
             CONTINUE
           ELSE
             MOVE CA-REQUEST-ID OF DFHCOMMAREA TO ZUT00000058(1)
             MOVE ZUT00000050 TO ZUT00000058(2)
           ...
           IF (CA-RETURN-CODE OF DFHCOMMAREA IS NUMERIC)
             ...
             CONTINUE
           ELSE
             MOVE CA-RETURN-CODE OF DFHCOMMAREA TO ZUT0000005A(1)
             MOVE 0 TO ZUT0000005A(2)
           ...
           ZUT0000005E(1)
             MOVE ZUT00000051 TO ZUT0000005E(2)
           ...
           ZUT00000060(1)
             MOVE ZUT00000052 TO ZUT00000060(2)
           ...
           ZUT00000062(1)
             MOVE ZUT00000053 TO ZUT00000062(2)
           ...
           TO ZUT00000064(1)
             MOVE ZUT00000054 TO ZUT00000064(2)
           ...
           TO ZUT00000066(1)
             MOVE ZUT00000055 TO ZUT00000066(2)
           ...
           DFHCOMMAREA(AZ-I:1) TO AZ-CONVERT-HEXIN
               ...
               MOVE AZ-CONVERT-HEXVAL TO ZUT00000068(1)(AZ-J:2)
             END-PERFORM
             PERFORM VARYING AZ-I FROM 1 BY 1 UNTIL AZ-I > 32432
               MOVE ZUT00000056(AZ-I:1) TO AZ-CONVERT-HEXIN
               PERFORM CONVERT
               COMPUTE AZ-J = AZ-I * 2 - 1
               MOVE AZ-CONVERT-HEXVAL TO ZUT00000068(2)(AZ-J:2)
             END-PERFORM
      ...
      *+---------------------------------------------------------------+
       ...
       01 AZ-TESTCASE-ID        PIC X(36)
           VALUE '39cb7564-7d94-4d78-97f9-3e225b711bf4'.
       LINKAGE SECTION.
       01 AZ-TEST               PIC X(80).
