      ...
      *| DATE GENERATED: 02/24/2021 11:04                              |
      ...
      *+---------------------------------------------------------------+
       ...
       1 AZ-COMPARE-ITEM-NAMES.
         ...
         3 ZUT00000048.
            ...
            5 PIC X(6) DISPLAY VALUE 'MMAREA'.
       1 AZ-COMPARE-WORK-ITEMS.
          3 ZUT00000031 PIC X(6) OCCURS 2.
          3 ZUT00000033 PIC 9(2) OCCURS 2.
          3 ZUT00000035 PIC 9(10) OCCURS 2.
          3 ZUT00000037 PIC X(10) OCCURS 2.
          ...
          3 ZUT00000047 PIC X(50) OCCURS 2.
      ...
      * EVALUATE OUTPUT VALUE
           ...
           IF CA-REQUEST-ID OF DFHCOMMAREA = ZUT00000025 THEN
             CONTINUE
           ELSE
             MOVE CA-REQUEST-ID OF DFHCOMMAREA TO ZUT00000031(1)
             MOVE ZUT00000025 TO ZUT00000031(2)
           ...
           IF (CA-RETURN-CODE OF DFHCOMMAREA IS NUMERIC)
             ...
             CONTINUE
           ELSE
             MOVE CA-RETURN-CODE OF DFHCOMMAREA TO ZUT00000033(1)
             MOVE 0 TO ZUT00000033(2)
           ...
           IF (CA-PATIENT-ID OF DFHCOMMAREA IS NUMERIC)
             ...
             CONTINUE
           ELSE
             MOVE CA-PATIENT-ID OF DFHCOMMAREA TO ZUT00000035(1)
             MOVE 2 TO ZUT00000035(2)
           ...
           ELSE
             MOVE CA-INS-CARD-NUM OF CA-PATIENT-REQUEST OF DFHCOMMAREA
           TO ZUT00000037(1)
             MOVE ZUT00000026 TO ZUT00000037(2)
           ...
           ELSE
             MOVE CA-FIRST-NAME OF CA-PATIENT-REQUEST OF DFHCOMMAREA
           TO ZUT00000039(1)
             MOVE ZUT00000027 TO ZUT00000039(2)
           ...
           ELSE
             MOVE CA-LAST-NAME OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT0000003B(1)
             MOVE ZUT00000028 TO ZUT0000003B(2)
           ...
           ELSE
             MOVE CA-DOB OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT0000003D(1)
             MOVE ZUT00000029 TO ZUT0000003D(2)
           ...
           ELSE
             MOVE CA-ADDRESS OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT0000003F(1)
             MOVE ZUT0000002A TO ZUT0000003F(2)
           ...
           ELSE
             MOVE CA-CITY OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT00000041(1)
             MOVE ZUT0000002B TO ZUT00000041(2)
           ...
           ELSE
             MOVE CA-POSTCODE OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT00000043(1)
             MOVE ZUT0000002C TO ZUT00000043(2)
           ...
           ELSE
             MOVE CA-PHONE-MOBILE OF CA-PATIENT-REQUEST OF DFHCOMMAREA
           TO ZUT00000045(1)
             MOVE ZUT0000002D TO ZUT00000045(2)
      ...
      *+---------------------------------------------------------------+
       ...
       1 AZ-COMPARE-ITEM-NAMES.
         ...
         3 ZUT0000006D.
            ...
            5 PIC X(6) DISPLAY VALUE 'MMAREA'.
       1 AZ-COMPARE-WORK-ITEMS.
          3 ZUT00000056 PIC X(6) OCCURS 2.
          3 ZUT00000058 PIC 9(2) OCCURS 2.
          3 ZUT0000005A PIC 9(10) OCCURS 2.
          3 ZUT0000005C PIC X(10) OCCURS 2.
          3 ZUT0000005E PIC X(10) OCCURS 2.
          3 ZUT00000060 PIC X(20) OCCURS 2.
          3 ZUT00000062 PIC X(10) OCCURS 2.
          3 ZUT00000064 PIC X(20) OCCURS 2.
          3 ZUT00000066 PIC X(20) OCCURS 2.
          3 ZUT00000068 PIC X(10) OCCURS 2.
          3 ZUT0000006A PIC X(20) OCCURS 2.
          3 ZUT0000006C PIC X(50) OCCURS 2.
          3 ZUT0000006E PIC X(10) OCCURS 2.
       01 AZ-CONVERT.
         03 AZ-CONVERT-HEXIN  PIC X(1).
         03 AZ-CONVERT-HEXVAL PIC X(2).
         03 AZ-HEXSTR PIC X(16) VALUE "0123456789ABCDEF".
      ...
      * EVALUATE OUTPUT VALUE
           MOVE 0 TO RETURN-CODE
           IF CA-REQUEST-ID OF DFHCOMMAREA = ZUT0000004A THEN
             CONTINUE
           ELSE
             MOVE CA-REQUEST-ID OF DFHCOMMAREA TO ZUT00000056(1)
             MOVE ZUT0000004A TO ZUT00000056(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000055
             MOVE LENGTH OF ZUT00000055 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000056(1)
             MOVE 6 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000056(2)
             MOVE 6 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           IF (CA-RETURN-CODE OF DFHCOMMAREA IS NUMERIC)
             ...
             CONTINUE
           ELSE
             MOVE CA-RETURN-CODE OF DFHCOMMAREA TO ZUT00000058(1)
             MOVE 01 TO ZUT00000058(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000057
             MOVE LENGTH OF ZUT00000057 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000058(1)
             MOVE 2 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000058(2)
             MOVE 2 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           IF (CA-PATIENT-ID OF DFHCOMMAREA IS NUMERIC)
             ...
             CONTINUE
           ELSE
             MOVE CA-PATIENT-ID OF DFHCOMMAREA TO ZUT0000005A(1)
             MOVE 2 TO ZUT0000005A(2)
           ...
           ELSE
             MOVE CA-INS-CARD-NUM OF CA-PATIENT-REQUEST OF DFHCOMMAREA
           TO ZUT0000005C(1)
             MOVE ZUT0000004B TO ZUT0000005C(2)
           ...
           ELSE
             MOVE CA-FIRST-NAME OF CA-PATIENT-REQUEST OF DFHCOMMAREA
           TO ZUT0000005E(1)
             MOVE ZUT0000004C TO ZUT0000005E(2)
           ...
           ELSE
             MOVE CA-LAST-NAME OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT00000060(1)
             MOVE ZUT0000004D TO ZUT00000060(2)
           ...
           ELSE
             MOVE CA-DOB OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT00000062(1)
             MOVE ZUT0000004E TO ZUT00000062(2)
           ...
           ELSE
             MOVE CA-ADDRESS OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT00000064(1)
             MOVE ZUT0000004F TO ZUT00000064(2)
           ...
           ELSE
             MOVE CA-CITY OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT00000066(1)
             MOVE ZUT00000050 TO ZUT00000066(2)
           ...
           ELSE
             MOVE CA-POSTCODE OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT00000068(1)
             MOVE ZUT00000051 TO ZUT00000068(2)
           ...
           ELSE
             MOVE CA-PHONE-MOBILE OF CA-PATIENT-REQUEST OF DFHCOMMAREA
           TO ZUT0000006A(1)
             MOVE ZUT00000052 TO ZUT0000006A(2)
           ...
           DFHCOMMAREA TO ZUT0000006C(1)
             MOVE ZUT00000053 TO ZUT0000006C(2)
           ...
           ELSE
             MOVE CA-USERID OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT0000006E(1)
             MOVE ZUT00000054 TO ZUT0000006E(2)
      ...
      *+---------------------------------------------------------------+
       ...
       1 AZ-COMPARE-ITEM-NAMES.
         ...
         3 ZUT00000086.
            ...
            5 PIC X(13) DISPLAY VALUE 'F DFHCOMMAREA'.
       1 AZ-COMPARE-WORK-ITEMS.
          3 ZUT00000077 PIC X(6) OCCURS 2.
          3 ZUT00000079 PIC 9(2) OCCURS 2.
          3 ZUT0000007B PIC 9(10) OCCURS 2.
          3 ZUT0000007D PIC X(10) OCCURS 2.
          3 ZUT0000007F PIC X(10) OCCURS 2.
          3 ZUT00000081 PIC X(10) OCCURS 2.
          3 ZUT00000083 PIC X(10) OCCURS 2.
          3 ZUT00000085 PIC X(10) OCCURS 2.
          3 ZUT00000087 PIC X(64864) OCCURS 2.
       01 AZ-CONVERT.
         03 AZ-CONVERT-HEXIN  PIC X(1).
         03 AZ-CONVERT-HEXVAL PIC X(2).
         03 AZ-HEXSTR PIC X(16) VALUE "0123456789ABCDEF".
      ...
      * EVALUATE OUTPUT VALUE
           MOVE 0 TO RETURN-CODE
           IF CA-REQUEST-ID OF DFHCOMMAREA = ZUT0000006F THEN
             CONTINUE
           ELSE
             MOVE CA-REQUEST-ID OF DFHCOMMAREA TO ZUT00000077(1)
             MOVE ZUT0000006F TO ZUT00000077(2)
           ...
           IF (CA-RETURN-CODE OF DFHCOMMAREA IS NUMERIC)
             ...
             CONTINUE
           ELSE
             MOVE CA-RETURN-CODE OF DFHCOMMAREA TO ZUT00000079(1)
             MOVE 0 TO ZUT00000079(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000078
             MOVE LENGTH OF ZUT00000078 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000079(1)
             MOVE 2 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000079(2)
             MOVE 2 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           IF (CA-PATIENT-ID OF DFHCOMMAREA IS NUMERIC)
             ...
             CONTINUE
           ELSE
             MOVE CA-PATIENT-ID OF DFHCOMMAREA TO ZUT0000007B(1)
             MOVE 4 TO ZUT0000007B(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT0000007A
             MOVE LENGTH OF ZUT0000007A TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT0000007B(1)
             MOVE 10 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT0000007B(2)
             MOVE 10 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ZUT0000007D(1)
             MOVE ZUT00000070 TO ZUT0000007D(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT0000007C
             MOVE LENGTH OF ZUT0000007C TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT0000007D(1)
             MOVE 10 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT0000007D(2)
             MOVE 10 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ZUT0000007F(1)
             MOVE ZUT00000071 TO ZUT0000007F(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT0000007E
             MOVE LENGTH OF ZUT0000007E TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT0000007F(1)
             MOVE 10 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT0000007F(2)
             MOVE 10 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ZUT00000081(1)
             MOVE ZUT00000072 TO ZUT00000081(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000080
             MOVE LENGTH OF ZUT00000080 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000081(1)
             MOVE 10 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000081(2)
             MOVE 10 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           TO ZUT00000083(1)
             MOVE ZUT00000073 TO ZUT00000083(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000082
             MOVE LENGTH OF ZUT00000082 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000083(1)
             MOVE 10 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000083(2)
             MOVE 10 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           TO ZUT00000085(1)
             MOVE ZUT00000074 TO ZUT00000085(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000084
             MOVE LENGTH OF ZUT00000084 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000085(1)
             MOVE 10 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000085(2)
             MOVE 10 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           DFHCOMMAREA(AZ-I:1) TO AZ-CONVERT-HEXIN
               ...
               MOVE AZ-CONVERT-HEXVAL TO ZUT00000087(1)(AZ-J:2)
             END-PERFORM
             PERFORM VARYING AZ-I FROM 1 BY 1 UNTIL AZ-I > 32432
               MOVE ZUT00000075(AZ-I:1) TO AZ-CONVERT-HEXIN
               PERFORM CONVERT
               COMPUTE AZ-J = AZ-I * 2 - 1
               MOVE AZ-CONVERT-HEXVAL TO ZUT00000087(2)(AZ-J:2)
             END-PERFORM
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000086
             MOVE LENGTH OF ZUT00000086 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000087(1)
