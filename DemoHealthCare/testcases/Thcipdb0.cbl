      ...
      *| DATE GENERATED: 03/31/2021 11:48                              |
      *| ID: 1338ead1-a5dd-455e-9fd0-71a6d0cd329a                      |
      *+---------------------------------------------------------------+
      *+---------------------------------------------------------------+
      *| TEST_TEST2                                                    |
      ...
      *+---------------------------------------------------------------+
       ...
       1 AZ-TEST-EXPECTED-DATA-VALUE.
          ...
          3 ZUT00000055.
            5 PIC X(16) DISPLAY VALUE 'Rua Good Dive 34'.
            5 PIC X(4) DISPLAY VALUE SPACES.
          3 ZUT00000056.
            5 PIC X(8) DISPLAY VALUE 'Ilhabela'.
            5 PIC X(12) DISPLAY VALUE SPACES.
          3 ZUT00000057.
            5 PIC X(5) DISPLAY VALUE '33566'.
            5 PIC X(5) DISPLAY VALUE SPACES.
          3 ZUT00000058.
            5 PIC X(9) DISPLAY VALUE '617-56478'.
            5 PIC X(11) DISPLAY VALUE SPACES.
          3 ZUT00000059.
            5 PIC X(14) DISPLAY VALUE 'myemail@br.com'.
            5 PIC X(36) DISPLAY VALUE SPACES.
          3 ZUT0000005A.
            5 PIC X(6) DISPLAY VALUE 'REGI24'.
            5 PIC X(4) DISPLAY VALUE SPACES.
          3 ZUT0000005B.
            5 PIC X(32302) DISPLAY VALUE SPACES.
       01 AZ-COMPARE.
      ...
      *+---------------------------------------------------------------+
       ...
       1 AZ-TEST-EXPECTED-DATA-VALUE.
          ...
          3 ZUT00000081.
            5 PIC X(1) DISPLAY VALUE SPACES.
            5 PIC X(49) DISPLAY VALUE SPACES.
          3 ZUT00000082.
            5 PIC X(1) DISPLAY VALUE SPACES.
            5 PIC X(9) DISPLAY VALUE SPACES.
          3 ZUT00000083.
       ...
       1 AZ-COMPARE-ITEM-NAMES.
         ...
         3 ZUT0000009E.
            ...
            5 PIC X(15) DISPLAY VALUE ' OF DFHCOMMAREA'.
       1 AZ-COMPARE-WORK-ITEMS.
          3 ZUT00000085 PIC X(6) OCCURS 2.
          3 ZUT00000087 PIC 9(2) OCCURS 2.
          3 ZUT00000089 PIC 9(10) OCCURS 2.
          3 ZUT0000008B PIC X(10) OCCURS 2.
          3 ZUT0000008D PIC X(10) OCCURS 2.
          3 ZUT0000008F PIC X(20) OCCURS 2.
          3 ZUT00000091 PIC X(10) OCCURS 2.
          3 ZUT00000093 PIC X(20) OCCURS 2.
          3 ZUT00000095 PIC X(20) OCCURS 2.
          3 ZUT00000097 PIC X(10) OCCURS 2.
          3 ZUT00000099 PIC X(20) OCCURS 2.
          3 ZUT0000009B PIC X(50) OCCURS 2.
          3 ZUT0000009D PIC X(10) OCCURS 2.
          3 ZUT0000009F PIC X(32302) OCCURS 2.
       LINKAGE SECTION.
       01 AZ-TEST                   PIC X(80).
       01 AZ-ARG-LIST.
         03 ARG-LENGTH PIC 9(4) COMP-4.
      ...
      * EVALUATE OUTPUT VALUE
           MOVE 0 TO RETURN-CODE
           IF CA-REQUEST-ID OF DFHCOMMAREA = ZUT00000078 THEN
             CONTINUE
           ELSE
             MOVE CA-REQUEST-ID OF DFHCOMMAREA TO ZUT00000085(1)
             MOVE ZUT00000078 TO ZUT00000085(2)
           ...
           IF (CA-RETURN-CODE OF DFHCOMMAREA IS NUMERIC)
             ...
             CONTINUE
           ELSE
             MOVE CA-RETURN-CODE OF DFHCOMMAREA TO ZUT00000087(1)
             MOVE 01 TO ZUT00000087(2)
           ...
           IF (CA-PATIENT-ID OF DFHCOMMAREA IS NUMERIC)
             ...
             CONTINUE
           ELSE
             MOVE CA-PATIENT-ID OF DFHCOMMAREA TO ZUT00000089(1)
             MOVE 5 TO ZUT00000089(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000088
             MOVE LENGTH OF ZUT00000088 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000089(1)
             MOVE 10 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000089(2)
             MOVE 10 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-INS-CARD-NUM OF CA-PATIENT-REQUEST OF DFHCOMMAREA
           TO ZUT0000008B(1)
             MOVE ZUT00000079 TO ZUT0000008B(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT0000008A
             MOVE LENGTH OF ZUT0000008A TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT0000008B(1)
             MOVE 10 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT0000008B(2)
             MOVE 10 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-FIRST-NAME OF CA-PATIENT-REQUEST OF DFHCOMMAREA
           TO ZUT0000008D(1)
             MOVE ZUT0000007A TO ZUT0000008D(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT0000008C
             MOVE LENGTH OF ZUT0000008C TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT0000008D(1)
             MOVE 10 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT0000008D(2)
             MOVE 10 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-LAST-NAME OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT0000008F(1)
             MOVE ZUT0000007B TO ZUT0000008F(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT0000008E
             MOVE LENGTH OF ZUT0000008E TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT0000008F(1)
             MOVE 20 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT0000008F(2)
             MOVE 20 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-DOB OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT00000091(1)
             MOVE ZUT0000007C TO ZUT00000091(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000090
             MOVE LENGTH OF ZUT00000090 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000091(1)
             MOVE 10 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000091(2)
             MOVE 10 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-ADDRESS OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT00000093(1)
             MOVE ZUT0000007D TO ZUT00000093(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000092
             MOVE LENGTH OF ZUT00000092 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000093(1)
             MOVE 20 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000093(2)
             MOVE 20 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-CITY OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT00000095(1)
             MOVE ZUT0000007E TO ZUT00000095(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000094
             MOVE LENGTH OF ZUT00000094 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000095(1)
             MOVE 20 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000095(2)
             MOVE 20 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-POSTCODE OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT00000097(1)
             MOVE ZUT0000007F TO ZUT00000097(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000096
             MOVE LENGTH OF ZUT00000096 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000097(1)
             MOVE 10 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000097(2)
             MOVE 10 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-PHONE-MOBILE OF CA-PATIENT-REQUEST OF DFHCOMMAREA
           TO ZUT00000099(1)
             MOVE ZUT00000080 TO ZUT00000099(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000098
             MOVE LENGTH OF ZUT00000098 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000099(1)
             MOVE 20 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000099(2)
             MOVE 20 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-EMAIL-ADDRESS OF CA-PATIENT-REQUEST OF
           DFHCOMMAREA TO ZUT0000009B(1)
             MOVE ZUT00000081 TO ZUT0000009B(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT0000009A
             MOVE LENGTH OF ZUT0000009A TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT0000009B(1)
             MOVE 50 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT0000009B(2)
             MOVE 50 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-USERID OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT0000009D(1)
             MOVE ZUT00000082 TO ZUT0000009D(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT0000009C
             MOVE LENGTH OF ZUT0000009C TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT0000009D(1)
             MOVE 10 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT0000009D(2)
             MOVE 10 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-ADDITIONAL-DATA OF CA-PATIENT-REQUEST OF
           DFHCOMMAREA TO ZUT0000009F(1)
             MOVE ZUT00000083 TO ZUT0000009F(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT0000009E
             MOVE LENGTH OF ZUT0000009E TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT0000009F(1)
             MOVE 254 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT0000009F(2)
             MOVE 254 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
      ...
      *+---------------------------------------------------------------+
       ...
       01 AZ-TESTCASE-ID        PIC X(36)
           VALUE '1338ead1-a5dd-455e-9fd0-71a6d0cd329a'.
       LINKAGE SECTION.
       01 AZ-TEST               PIC X(80).
      ...
      * EXEC SQL SELECT_INTO : OUT=1 IN=10
       ...
       I00E70-SQL913.
           ...
           MOVE ZUT00000000 TO CA-FIRST-NAME OF ZUT0000000B
           MOVE ZUT00000001 TO CA-LAST-NAME OF ZUT0000000C
           MOVE ZUT00000002 TO CA-DOB OF ZUT0000000D
           MOVE ZUT00000003 TO CA-INS-CARD-NUM OF ZUT0000000E
           MOVE ZUT00000004 TO CA-ADDRESS OF ZUT0000000F
           MOVE ZUT00000005 TO CA-CITY OF ZUT00000010
           MOVE ZUT00000006 TO CA-POSTCODE OF ZUT00000011
           MOVE ZUT00000007 TO CA-PHONE-MOBILE OF ZUT00000012
           MOVE ZUT00000008 TO CA-EMAIL-ADDRESS OF ZUT00000013
           MOVE ZUT00000009 TO CA-USERID OF ZUT00000014
